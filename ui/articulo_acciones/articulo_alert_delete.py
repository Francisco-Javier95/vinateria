...
def alerta_eliminar(regresar = None, formulario_visible = False, cerrando_modal = None, registro = None):
    ...
    def confirmar(evento):
        ...
        try:
            ...
            eliminar_articulo = Articulo_eliminar(articulo_id = articulo_id,)

            articulo_dao.eliminar(eliminar_articulo)

            mensaje.value = f"Articulo {articulo_articulo} ha sido eliminado exitosamente"
            mensaje.color = ft.Colors.GREEN
            print(f"Articulo {articulo_articulo} ha sido eliminado exitosamente de ID {articulo_id}")
