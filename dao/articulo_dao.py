...
class ArticuloDAO:
    ...
    def obtener_todos(self):
        ...
        cursor.execute("SELECT a.articulo_id, a.articulo_articulo, a.articulo_codigo, c.categoria_categoria, a.articulo_imagen, a.articulo_precio, a.articulo_stock, p.proveedor_proveedor FROM articulos_1 a INNER JOIN categorias c ON a.articulo_categoria = c.categoria_id INNER JOIN proveedores p ON a.articulo_proveedor = p.proveedor_id ORDER BY a.articulo_id ASC")
